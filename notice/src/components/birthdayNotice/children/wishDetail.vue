<template>
  ...
  <div class="wish-detail" >
    <scroll ref="scroll" class="detail-container" style="background: rgba(7, 17, 27, .05)" :data="noticeWishList" :mouseWheel="mouseWheel">
      ...
      <div class="head">
        <div class="head-img">
          <span class="icon" v-if="noticeDate == 0 || _noticetime == 0"><i class="icon-crown"></i></span>
        ...
        <div class="head-other">
          <span v-if="noticeDate == 0 || _noticetime == 0" class="text">今天是您的生日，生日快乐！</span>
          <span v-else class="text">{{noticeDate}}天后是您的生日！</span>
        </div>
      </div>
      <!-- 背景蒙层 -->
