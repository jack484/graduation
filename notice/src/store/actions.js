...
export const saveWishList = function ({commit}, list) {
  commit(types.SAVE_WISHLIST, list)
}

export const saveUserInfo = function ({commit}, info) {
  commit(types.SAVE_USERINFO, info)
}

export const saveResponseId = function ({commit}, resid) {
  commit(types.SAVE_RESPONSEID, resid)
}
...
// festivalId
export const saveFestivalId = function ({commit}, festivalId) {
  commit(types.SAVE_FESTIVALID, festivalId)
}
