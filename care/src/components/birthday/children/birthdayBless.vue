<template>
  ...
  <div ref="scroll" class="blessing-page">
    <div class="blessing-container">
      <div class="head" v-if="noticeItem.v_status == 'birthday'">
        <div class="head-img">
        ...
        <div class="head-other" v-if="noticeItem.statusDate == 1">
          <span v-if="noticeItem.noticeDate == 0 || noticeItem.noticetime == 0" class="text">今天是Ta的生日，快来送上祝福吧！</span>
